...
//8 Dado un objeto de nombre Led obtén el valor de las propiedades rojo, verde y azul guardándolo en la
//variable array RGB[Rojo, Verde, Azul]
...
//(imprime por consola 'despegando'), función volar (imprime por consola llegando al destino), función aterrizar (imprime por consola 'aterrizando'
...
//21 Dado un objeto de nombre Pantalla obtén el valor de la propiedad array bidimensional
// pixeles guardándolo en la variable pixeles.

const pixeles = Pantalla.pixeles;

//22 Dado un objeto de nombre Movil obtén el valor de la propiedad especificaciones con ["especificaciones"]
